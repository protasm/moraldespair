...
void long(string str) {
    ...
    if (str == "door") {
        if (!"domain/lp-245/room/elevator"->query_door(0) && "domain/lp-245/room/elevator"->query_level(0))
...
int xyzzy() {
    ...
    this_player()->move_player("elsewhere#domain/lp-245/room/test");
    return 1;
}

int west() {
    if ("domain/lp-245/room/elevator"->query_door(0) ||
        "domain/lp-245/room/elevator"->query_level(0) != 2) {
        write("The door is closed.\n");
        return 1;
    }
    this_player()->move_player("west#domain/lp-245/room/elevator");
    return 1;
}
...
int open(string str) {
    if (str != "door")
        return 0;
    if ("domain/lp-245/room/elevator"->query_level(0) != 2) {
        write("You can't when the elevator isn't here.\n");
        return 1;
    }
    "domain/lp-245/room/elevator"->open_door("door");
    return 1;
}
...
int close(string str) {
    if (str != "door")
        return 0;
    "domain/lp-245/room/elevator"->close_door("door");
    return 1;
}
...
int push(string str) {
    if (str && str != "button")
        return 0;
    if ("domain/lp-245/room/elevator"->call_elevator(2))
        lamp_is_lit = 1;
    return 1;
}
...
int south() {
    this_player()->move_player("south#domain/lp-245/room/vill_green");
    return 1;
}
