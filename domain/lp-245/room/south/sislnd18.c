...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd13");
    return 1;
}

int south() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd16");
    return 1;
}

int east() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd15");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sislnd17");
    return 1;
}
