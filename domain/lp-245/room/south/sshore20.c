...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sforst28");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sforst30");
    return 1;
}

int northeast() {
    this_player()->move_player("northeast#domain/lp-245/room/south/sshore21");
    return 1;
}

int southwest() {
    this_player()->move_player("southwest#domain/lp-245/room/south/sshore19");
    return 1;
}
