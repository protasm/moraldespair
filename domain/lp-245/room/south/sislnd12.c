...
int south() {
    this_player()->move_player("south#domain/lp-245/room/south/sislnd17");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sislnd13");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sislnd11");
    return 1;
}

int northeast() {
    this_player()->move_player("northeast#domain/lp-245/room/south/sislnd1");
    return 1;
}
