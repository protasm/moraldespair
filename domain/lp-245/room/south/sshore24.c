...
int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sforst49");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sshore23");
    return 1;
}

int southeast() {
    this_player()->move_player("southeast#domain/lp-245/room/south/sshore25");
    return 1;
}
