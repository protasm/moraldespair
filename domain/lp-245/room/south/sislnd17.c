...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd12");
    return 1;
}

int south() {
    this_player()->move_player("south#domain/lp-245/room/south/sislnd8");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sislnd18");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sislnd9");
    return 1;
}

int down() {
    this_player()->move_player("down the well#domain/lp-245/room/south/lair");
    return 1;
}
