...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sshore3");
    return 1;
}

int south() {
    this_player()->move_player("south#domain/lp-245/room/south/sshore5");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sforst12");
    return 1;
}
