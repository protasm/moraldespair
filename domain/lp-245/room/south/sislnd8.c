...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd17");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sislnd16");
    return 1;
}

int southeast() {
    this_player()->move_player("southeast#domain/lp-245/room/south/sislnd7");
    return 1;
}

int northwest() {
    this_player()->move_player("northwest#domain/lp-245/room/south/sislnd9");
    return 1;
}
