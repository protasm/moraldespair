...
int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sshore24");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sforst21");
    return 1;
}

int southwest() {
    this_player()->move_player("southwest#domain/lp-245/room/south/sshore22");
    return 1;
}
