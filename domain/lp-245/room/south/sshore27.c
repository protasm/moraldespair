...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sforst47");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sforst46");
    return 1;
}

int northeast() {
    this_player()->move_player("northeast#domain/lp-245/room/south/sshore28");
    return 1;
}

int southwest() {
    this_player()->move_player("southwest#domain/lp-245/room/south/sshore26");
    return 1;
}
