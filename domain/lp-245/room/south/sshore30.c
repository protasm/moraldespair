...
int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sforst8");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sshore28");
    return 1;
}

int southeast() {
    this_player()->move_player("southeast#domain/lp-245/room/south/sshore1");
    return 1;
}
