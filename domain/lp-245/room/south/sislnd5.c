...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd4");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sislnd15");
    return 1;
}

int southwest() {
    this_player()->move_player("southwest#domain/lp-245/room/south/sislnd6");
    return 1;
}
