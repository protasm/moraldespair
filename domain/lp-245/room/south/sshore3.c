...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sshore2");
    return 1;
}

int south() {
    this_player()->move_player("south#domain/lp-245/room/south/sshore4");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sforst11");
    return 1;
}
