...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sforst46");
    return 1;
}

int northeast() {
    this_player()->move_player("northeast#domain/lp-245/room/south/sshore27");
    return 1;
}

int northwest() {
    this_player()->move_player("northwest#domain/lp-245/room/south/sshore25");
    return 1;
}
...
int southeast() {
    ...
    this_player()->move_player("southeast#domain/lp-245/room/south/sislnd1");
    return 1;
}
