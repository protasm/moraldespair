...
int northwest() {
    this_player()->move_player("northwest#domain/lp-245/room/south/sshore18");
    return 1;
}

int south() {
    this_player()->move_player("south#domain/lp-245/room/south/sforst34");
    return 1;
}

int southeast() {
    this_player()->move_player("southeast#domain/lp-245/room/south/sshore16");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sforst33");
    return 1;
}
