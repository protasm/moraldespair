...
int south() {
    this_player()->move_player("south#domain/lp-245/room/south/sislnd13");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sislnd2");
    return 1;
}
...
int northwest() {
    write("You trust in your faith and step oun onto the near invisible " +
          "bridge...");
    this_player()->move_player("northwest#domain/lp-245/room/south/sshore26");
    return 1;
}

int southwest() {
    this_player()->move_player("southwest#domain/lp-245/room/south/sislnd12");
    return 1;
}
