...
int northeast() {
    this_player()->move_player("northeast#domain/lp-245/room/south/sshore8");
    return 1;
}

int east() {
    this_player()->move_player("east#domain/lp-245/room/south/sforst20");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sshore10");
    return 1;
}
