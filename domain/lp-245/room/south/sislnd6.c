...
int north() {
    this_player()->move_player("north#domain/lp-245/room/south/sislnd5");
    return 1;
}

int west() {
    this_player()->move_player("west#domain/lp-245/room/south/sislnd16");
    return 1;
}

int northeast() {
    this_player()->move_player("northeast#domain/lp-245/room/south/sislnd5");
    return 1;
}

int southwest() {
    this_player()->move_player("southwest#domain/lp-245/room/south/sislnd7");
    return 1;
}
