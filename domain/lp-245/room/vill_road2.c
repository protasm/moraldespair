...
void reset(int arg) {
    dest_dir = ({"domain/lp-245/room/vill_road1", "west", "domain/lp-245/room/vill_shore", "east",
                 "domain/lp-245/room/adv_guild", "south", "domain/lp-245/room/station", "down", "domain/lp-245/room/shop",
                 "north"});
...
int down() {
    this_player()->move_player("down#domain/lp-245/room/station");
    return 1;
}
