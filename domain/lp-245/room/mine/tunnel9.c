...
#undef EXTRA_LONG
#define EXTRA_LONG                                                             \
    if ("domain/lp-245/room/mine/tunnel3"->query_rope())                                     \
        write("There is a rope hanging down through the hole.\n");

TWO_EXIT("domain/lp-245/room/mine/tunnel10", "west", "domain/lp-245/room/mine/tunnel14", "east",
...
int go_up() {
    ...
    this_player()->move_player("up#domain/lp-245/room/mine/tunnel8");
    return 1;
}
