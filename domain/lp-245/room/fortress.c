void extra_reset() {
    ...
    if (!present("orc")) {
        while (i < 8) {
            ...
            orc->load_a_chat(40, "domain/lp-245/room/orc_vall"->get_chats());
            n = random(3);
...
int north() {
    ...
    this_player()->move_player("north#domain/lp-245/room/orc_treasure");
    return 1;
}

int south() {
    this_player()->move_player("south#domain/lp-245/room/orc_vall");
    return 1;
}
