...
void create() {
  ...
  dest_dir = ([
    "north" : "/chapter/prologue/area/island/room613",
    "east" : "/chapter/prologue/area/island/room674",
    "south" : "/chapter/prologue/area/island/room611",
    "west" : "/chapter/prologue/area/island/room642",
  ]);
}
