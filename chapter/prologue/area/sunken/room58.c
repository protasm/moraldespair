...
void create() {
  ...
  dest_dir = ({
    "chapter/prologue/area/sunken/room57", "north",
    "chapter/prologue/area/sunken/room59", "south",
    "chapter/prologue/area/sunken/room966", "east",
    "chapter/prologue/area/sunken/room965", "west",
  });
