...
void create() {
  ...
  dest_dir = ([
    "south":"/chapter/prologue/area/ruined/room220",
    "west":"/chapter/prologue/area/ruined/room118",
    "east":"/chapter/prologue/area/ruined/room116",
    "north":"/chapter/prologue/area/ruined/room226",
  ]);
