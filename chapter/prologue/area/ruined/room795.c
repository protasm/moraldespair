...
void create() {
  ...
  dest_dir = ([
    "south":"/chapter/prologue/area/ruined/room813",
    "west":"/chapter/prologue/area/ruined/room792",
    "east":"/chapter/prologue/area/ruined/room796",
    "north":"/chapter/prologue/area/ruined/room797",
  ]);
