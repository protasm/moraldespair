...
void create() {
  ...
  dest_dir = ([
    "south":"/chapter/prologue/area/ruined/room233",
    "west":"/chapter/prologue/area/ruined/room117",
    "east":"/chapter/prologue/area/ruined/room115",
    "north":"/chapter/prologue/area/ruined/room172",
  ]);
