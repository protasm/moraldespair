...
void create() {
  ::create();
    ...
    dest_dir = ([
      "south":"/chapter/prologue/area/ruined/room116",
      "west":"/chapter/prologue/area/ruined/room226",
      "east":"/chapter/prologue/area/ruined/room735",
      "north":"/chapter/prologue/area/ruined/room173",
    ]);
