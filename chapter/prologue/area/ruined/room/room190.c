...
void create() {
  ::create();
    ...
    dest_dir = ([
      "south":"/chapter/prologue/area/ruined/room/room740",
      "west":"/chapter/prologue/area/ruined/room/room191",
      "east":"/chapter/prologue/area/ruined/room/room189",
      "north":"/chapter/prologue/area/ruined/room/room741",
    ]);
